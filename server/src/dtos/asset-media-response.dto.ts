...
// TODO: add meta.id to the enum (breaking change for client imports)
const AssetUploadActionSchema = z.enum(AssetUploadAction).describe('Upload action');
...
const AssetRejectReasonSchema = z.enum(AssetRejectReason).describe('Rejection reason if rejected');
